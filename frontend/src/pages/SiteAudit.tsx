                ...
                <div className="audit-section">
                  ...
                  <div className="seo-recommendation">
                    <p className="recommendation-text">
                      ...
                      Там вы сможете увидеть <strong style={{color: '#09CEA7'}}>скорость загрузки сайта</strong> и 
                      полноценную оценку от Google PageSpeed Insights
                    </p>
                    <Link 
                      to={createLink(`/seo-audit?url=${encodeURIComponent(result.url)}`)} 
