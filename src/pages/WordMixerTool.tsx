...
const WordMixerTool: React.FC = () => {
    ...
    useEffect(() => {
        setLaunchCount(statsService.getLaunchCount('word-mixer'));
    }, []);
    ...
    const handleShowResult = () => {
        ...
        statsService.incrementLaunchCount('word-mixer');
                ...
                <div className="quad-input">
                    ...
                    <div className="input-field">
                        ...
                        <div className="input-controls">
                            ...
                            <span className="char-counter">{inputLines3} стр.</span>
                        </div>
                    </div>
                    ...
                    <div className="input-field">
                        ...
                        <div className="input-controls">
                            ...
                            <span className="char-counter">{inputLines4} стр.</span>
                        </div>
                    </div>
                </div>
            </div>
