...
// Новые emoji для категории "Символы"
export const symbolsEmoji: EmojiItem[] = [
    { emoji: '⭐', keywords: ['star', 'звезда', 'зірка'], category: 'symbols' },
    { emoji: '✅', keywords: ['checkmark', 'галочка', 'галочка', 'done'], category: 'symbols' },
    { emoji: '❌', keywords: ['cross', 'крестик', 'хрестик', 'error'], category: 'symbols' },
